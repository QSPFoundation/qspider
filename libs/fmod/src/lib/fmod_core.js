var FMODModule = (function () {
  ...
  return function (FMODModule) {
    ...
    function integrateWasmJS() {
      var wasmTextFile = 'fmod.wast';
      var wasmBinaryFile = 'fmod.wasm';
      var asmjsCodeFile = 'fmod.temp.asm.js';
    ...
    STATICTOP = STATIC_BASE + 484992;
    __ATINIT__.push(
      {
        func: function () {
          __GLOBAL__sub_I_fmod_music_cpp();
        },
      },
      {
        func: function () {
          __GLOBAL__sub_I_fmod_os_js_api_cpp();
        },
      },
      {
        func: function () {
          __GLOBAL__sub_I_platform_os_js_generated_api_cpp();
        },
      },
      {
        func: function () {
    ...
    Module['wasmTableSize'] = 2119;
    Module['wasmMaxTableSize'] = 2119;
    Module.asmGlobalArg = {};
    Module.asmLibraryArg = {
      ...
      F: ___atomic_fetch_add_8,
      M: ___cxa_pure_virtual,
      H: ___lock,
      w: ___setErrNo,
      E: ___syscall140,
      D: ___syscall145,
      ...
      L: _emscripten_asm_const_iiii,
      K: _emscripten_asm_const_iiiii,
      J: _emscripten_async_call,
    ...
    var __GLOBAL__sub_I_fmod_music_cpp = (Module[
      '__GLOBAL__sub_I_fmod_music_cpp'
    ] = function () {
      return Module['asm']['ca'].apply(null, arguments);
    });
    var __GLOBAL__sub_I_fmod_os_js_api_cpp = (Module[
      '__GLOBAL__sub_I_fmod_os_js_api_cpp'
    ] = function () {
      return Module['asm']['da'].apply(null, arguments);
    });
    var __GLOBAL__sub_I_platform_os_js_generated_api_cpp = (Module[
      '__GLOBAL__sub_I_platform_os_js_generated_api_cpp'
    ] = function () {
    ...
    var dynCall_viiiiiiiifffii = (Module[
